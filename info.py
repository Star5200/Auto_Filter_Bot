...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '889853031').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002739443803').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003947384371'))  # Log channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/2be6328d8f0aeed07912c-595eb04817bcc59cbc.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '190620025200@ybl')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://stargaming19062002_db_user:dev123@cluster0.iwrylmb.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'starcinema_files') # Collection name (default: dreamcinezone_files)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Star_CinemaTm') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Choudhary5200') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Star_CinemaTm') # Update channel link for the bot
